...
void Go_ahead_Avoidance()
{
    ...
    //amcl_linear_ahead_avoidance(0.07,0.4,2,0,Increase_speed,0);
    //amcl_linear_ahead_avoidance(0.4,0.4,3,0,Uniform_speed,0);
    //amcl_linear_ahead_avoidance(0.4,0.05,5,0,Decrease_speed,0);
}
...
{ 
   ...
   //      oFile<< "X "<< " "<<i<<" "<<"Y "<<" "<<i*i<<endl;
    ...
    float Angle_Arc    = 0;
    oFile_init.open("3mini_pid.csv",ios::out|ios::trunc);
