...
class ImageCreator():
      def __init__(self):
        ...
        with rosbag.Bag('2019-04-24-14-01-02.bag','r') as bag:  #要读取的bag文件；
            for topic,msg,t in bag.read_messages():
                ...
                if topic == "/camera1/grayimage": #图像的topic；
                        ...
                        #cv_image = cv2.putText(cv_image, str(get_control_value[0].linear.x), (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
                        image_name = str(flagpp[0])+'-'+str(round(value1[0],2))+'-'+str(round(value2[0],5))+ ".png" #图像命名：时间戳.png
                        cv_image = cv2.putText(cv_image, str(round(get_control_value[0],4)), (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
